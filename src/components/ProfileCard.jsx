...
const DEFAULT_INNER_GRADIENT =
  "linear-gradient(145deg, rgba(220,38,38,0.4) 0%, rgba(236,72,153,0.3) 50%, rgba(251,146,60,0.3) 100%)";
...
const ProfileCardComponent = ({
  ...
  const cardStyle = useMemo(
    () => ({
     ...
     '--behind-glow-color': behindGlowColor ?? 'rgba(239, 68, 68, 0.6)',
      ...
      '--sunpillar-1': '#ef4444',   // red
'--sunpillar-2': '#f43f5e',   // rose
'--sunpillar-3': '#fb7185',   // pink
'--sunpillar-4': '#fb923c',   // orange
'--sunpillar-5': '#f97316',   // deep orange
'--sunpillar-6': '#facc15',   // warm highlight
